...
indexNoFarm <- which(datSet$Occupation != 'farming')

datSet$Occupation[indexFarm]   <- 1    # 1 --> farming
datSet$Occupation[indexNoFarm] <- 0    # 0 --> non farming
