...
## Simple model
Here we implement a simpe logistic regression model. 
...
# Run Stan
resStan <- stan(model_code = stan_code_simple,
                data = dat,
                chains = 5, 
                iter = 2000, 
                warmup = 800,
...
## Factors selection 
In this section we will evaluate the most influential factors and their correlation in order to select the most descriptive ones that will be used to contruct our models.\newline
...
## Load Stan Model
fileNameTwoDef <- "./logistic_regression_model_def.stan"
stan_code_hier_def <- readChar(fileNameTwoDef, file.info(fileNameTwoDef)$size)
cat(stan_code_hier_def)
...
# Run Stan
resStan <- stan(model_code = stan_code_simple_def,
                data = dat_def,
                chains = 5, 
                iter = 2000, 
                warmup = 800,
